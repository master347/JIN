...
def mainx():
    ...
    print(f'{K} [{H}8{K}] {N}Contract JIN')
    ...
    if mahin in ["1","01"]:
     ...
     print(f'{gen}{RED}Exited {H}JIN {P}Terminal ');os.system("xdg-open https://www.facebook.com/JIN.Army00");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.king.JIN/?ref=share');exit()
    else:
...
def x7():
  ...
  input(f'{dot}Press Enter To Go Menu');os.system('python JIN.py')
